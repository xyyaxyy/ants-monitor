import { BreadCrumbTypes, ErrorTypes, globalVar } from 'ants-monitor-shared';
import {
  getLocationHref,
  getTimestamp,
  Severity,
...
import { ReportDataType, MonitorHttp, Replace, ResourceErrorTarget } from 'ants-monitor-types';
